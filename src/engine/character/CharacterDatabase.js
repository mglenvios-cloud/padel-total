/**
 * CharacterDatabase - Base de datos de parámetros y presets de personajes.
 */
const CharacterDatabase = {
  ...
  getPreset(role, id) {
    if (role === 'referee') return this.presets.referee;
    if (role === 'coach') return this.presets.coach;
